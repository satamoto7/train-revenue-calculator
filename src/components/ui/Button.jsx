...
const buttonVariants = {
  ...
  secondary:
    'border-border-subtle bg-surface-elevated text-text-primary hover:border-brand-primary/30 hover:bg-brand-soft/60',
  danger: 'border-status-danger/25 bg-surface-elevated text-status-danger hover:bg-status-danger/5',
